...
class CuckooSearch_rand : public Solver<vector<Solution>>  {
protected:
	...
	Utility localSearchseting;
public:
	CuckooSearch_rand(algorithmCategory, Utility&, vector<Solution>&, TerminationCriteria&, double);
