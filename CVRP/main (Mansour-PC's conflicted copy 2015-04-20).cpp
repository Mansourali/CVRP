...
// Version     : 1.00
// Copyright   : All copyright is reserved 
// Description : Solving the capacitated VRP with different Heuristic and MetaHeuristic
// 
//=======================================================================================
#include "utility.h"
#include "instance.h"
...
int main () {
	...
	u.POPULATION.setTERMINATION_CRITERIA	( 300 );
	...
	u.SINGLE.setTERMINATION_CRITERIA		( 100 );
	...
	vector<vector<double>> constructionDiver, constructionBest;
		...
		for (size_t currentInstance = 3; currentInstance < 15; currentInstance++)	{
